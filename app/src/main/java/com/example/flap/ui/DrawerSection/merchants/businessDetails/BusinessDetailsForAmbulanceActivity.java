...
public class BusinessDetailsForAmbulanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_business_details_for_ambullance);
        Objects.requireNonNull(getSupportActionBar()).setTitle("Upload Ambulance Details");
...
//        progress dialog
        ...
        submitDetails = findViewById(R.id.submitBusinessDetailsForAmbulance);
